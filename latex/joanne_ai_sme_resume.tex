...
\begin{itemize}
    \item Develop and maintain all learning materials for \textbf{12 subjects}, with \textbf{20 course offerings} taught since January 2025: weekly instructional content, sample code repositories, reference sheets, recorded walkthroughs, and open-source GitHub archives
...
\begin{itemize}
    ...
    \item Computing for Non-Majors required translating technical concepts for a non-technical audience, directly transferable to AI for Business Leaders contexts
\end{itemize}
...
Academic integrity / responsible AI use slide deck available on request.
